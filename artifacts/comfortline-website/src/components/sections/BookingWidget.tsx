...
export function BookingWidget() {
  ...
  useEffect(() => {
    function onOutside(e: MouseEvent) {
      const inDesktop = paxRef.current && paxRef.current.contains(e.target as Node);
      const inMobile  = paxRefMob.current && paxRefMob.current.contains(e.target as Node);
      if (!inDesktop && !inMobile) setPaxOpen(false);
    }
