    ...
    body: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["ComfortLine (трансфер)", "Частный автомобиль", "6–8 ч", "от 160 €/авто", "Без ограничений"],
        ],
      },
      {
        type: "callout",
      ...
      },
      {
        ...
        rows: [
          ...
          ["ComfortLine (трансфер)", "2,5–3 ч", "от 90 €/авто", "Прямо к терминалу вылета"],
        ],
      },
      {
        type: "p",
      ...
      },
      {
        ...
        rows: [
          ...
          ["Цена за группу 3–4 человека", "30–80 € × кол-во мест", "от 90–160 € за авто"],
        ],
      },
      ...
      {
        type: "p",
        text: "До Вильнюса — да, автобус выгоднее. До Варшавы вдвоём автобус стоит 50–90 €, плюс такси до аэропорта 15–25 € × 2 + риск задержки. Трансфер на двоих до WAW — от 160 € за машину, но без пересадок, от двери до терминала.",
      },
      {
        type: "h3",
