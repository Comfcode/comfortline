...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    body: [
      {
        type: "callout",
        text: "Актуальный официальный список стран и условий безвизового въезда публикует Министерство иностранных дел Республики Беларусь: mfa.gov.by/en/visa/freemove/europe/ — проверяйте перед поездкой, правила периодически обновляются.",
      },
      { type: "h2", text: "Три действующих безвизовых режима в 2026 году" },
      {
        type: "p",
        text: "Беларусь предлагает несколько форматов безвизового въезда для иностранных граждан. Они различаются по длительности пребывания, списку стран и разрешённым пунктам пропуска. Важно понять, какой именно режим подходит вам, ещё до выезда.",
      },
      {
        type: "table",
        headers: ["Режим", "Длительность", "Въезд через", "Охват стран"],
        rows: [
          ["Минский аэропорт (MSQ)", "до 30 дней", "Только Минский аэропорт", "74+ страны, все страны ЕС"],
          ["Гродненская область", "до 15 дней", "КПП Брузги, Берестовица, Песчатка", "74+ страны"],
          ["Августовский канал", "до 10 дней", "КПП Лесная (Польша)", "74+ страны"],
        ],
      },
      { type: "h2", text: "Режим 1 — через Минский аэропорт: до 30 дней" },
      {
        type: "p",
        text: "Самый распространённый режим. Граждане более 74 государств — включая все страны Евросоюза, Великобританию, США, Канаду, Австралию, Японию и многие другие — могут прилететь в Беларусь без визы и остаться до 30 календарных дней. Въезд строго через Национальный аэропорт Минск (MSQ). При этом выехать можно через любой пограничный переход — автомобильный, железнодорожный или тот же аэропорт.",
      },
      {
        type: "ul",
        items: [
          "Срок пребывания — не более 30 дней с даты въезда.",
          "Въезд — только через Национальный аэропорт Минск.",
      ...
      {
        type: "callout",
        text: "Если вы летите в Минск из Варшавы, Вильнюса, Риги, Берлина или другого европейского города — этот режим действует автоматически. Обратный вариант тоже работает: долететь до ближайшего европейского аэропорта и дальше добраться трансфером.",
      },
      { type: "h2", text: "Режим 2 — Гродненская область: до 15 дней" },
      {
        type: "p",
        text: "Специальный туристический режим для посещения Гродненского региона — одного из самых красивых в Беларуси. Гродно, Мирский и Несвижский замки, Августовский канал — всё это в пределах одной области. Въезд только через три специально выделенных КПП на границе с Польшей.",
      },
      {
        type: "ul",
        items: [
          "КПП Брузги — основной автомобильный переход Гродно–Кузница (Польша).",
          "КПП Берестовица — переход Большая Берестовица–Бобровники (Польша).",
          "КПП Песчатка — переход Песчатка–Половце (Польша).",
        ],
      },
      {
        type: "p",
        text: "Для въезда в рамках гродненского режима потребуется иметь при себе документы, подтверждающие туристическую цель визита, и медицинскую страховку. Передвигаться разрешено по всей Гродненской области, но не по другим регионам страны.",
      },
      { type: "h2", text: "Режим 3 — Августовский канал: до 10 дней" },
      {
        type: "p",
        text: "Узкоспециализированный режим для посещения зоны Августовского канала — уникального исторического водного пути на стыке Польши и Беларуси. Въезд только через КПП Лесная. Разрешённая зона пребывания строго ограничена Гродненским районом в пределах, примыкающих к каналу. Подходит для любителей природы, водного туризма и исторических маршрутов.",
      },
      { type: "h2", text: "Страны с правом безвизового въезда" },
      {
        type: "p",
        text: "Полный и актуальный перечень публикуется на сайте МИД РБ. В числе стран, граждане которых могут въехать без визы:",
      },
      {
        type: "ul",
        items: [
          ...
          "Великобритания (после Brexit — отдельное подтверждение).",
          ...
          "И многие другие — всего более 74 государств.",
        ],
      },
      {
        type: "link",
        href: "https://mfa.gov.by/en/visa/freemove/europe/",
      ...
      {
        type: "p",
        text: "Это зависит от конкретного режима. При въезде через Гродненский регион через специально выделенные КПП (Брузги, Берестовица, Песчатка) — виза не нужна гражданам 74+ стран. При въезде через другие сухопутные пограничные переходы, не включённые в программу безвизового режима, стандартная виза по-прежнему требуется.",
      },
