...
const data: RoutePageData = {
  ru: {
    ...
    faq: [
      { q: "Сколько стоит трансфер из Минска в Варшаву?", a: "Цена — по запросу, свяжитесь с нами. Стоимость зависит от класса авто (бизнес-седан 1–4 пассажира или минивэн 5–8), необходимости детского кресла, поездки с домашним животным, конечного адреса в Варшаве, сезона и других пожеланий клиента. Менеджер озвучит фиксированную сумму без счётчика — без доплат на месте, с включёнными топливом, страховкой, помощью на границе, водой и багажом без ограничений." },
  ...
  en: {
    ...
    faq: [
      { q: "How much does a Minsk to Warsaw transfer cost?", a: "Price is on request — please contact us. The exact figure depends on the vehicle class (business sedan for 1–4 passengers or minivan for 5–8), whether you need a child seat, whether you travel with a pet, your final Warsaw address, the season, and any other special requests. Our manager confirms a fixed price (no meter) with fuel, insurance, border assistance, bottled water and unlimited luggage already included — no extras at pickup or drop-off." },
