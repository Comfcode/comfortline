...
const data: RoutePageData = {
  ru: {
    ...
    faq: [
      { q: "Сколько стоит трансфер из Минска в Варшаву?", a: "У нас фиксированная цена за всю машину (1–4 пассажира на бизнес-седане; 5–8 — на минивэне). Точную сумму называет менеджер при бронировании в зависимости от класса авто, конечного адреса в Варшаве и сезона. В стоимость уже включены топливо, страховка, помощь на границе, бутилированная вода и багаж без ограничений — никаких доплат на месте." },
  ...
  en: {
    ...
    faq: [
      { q: "How much does a Minsk to Warsaw transfer cost?", a: "We quote a fixed price per car (1–4 passengers in a business sedan; 5–8 in a minivan). The exact figure is confirmed by our manager at booking based on the vehicle class, your final Warsaw address and the season. Fuel, insurance, border assistance, bottled water and unlimited luggage are already included — no extras at pickup or drop-off." },
