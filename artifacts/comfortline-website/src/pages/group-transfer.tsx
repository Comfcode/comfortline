...
const data: RoutePageData = {
  ru: {
    ...
    ctaDesc: "Укажите количество человек и маршрут — получите точную цену в ближайшее время.",
  ...
  en: {
    ...
    ctaDesc: "Tell us your group size and destination — get an exact price shortly.",
