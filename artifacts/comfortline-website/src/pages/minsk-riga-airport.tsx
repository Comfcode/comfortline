  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Seo
        ...
        descRu="Индивидуальный трансфер из Минска в международный аэропорт Риги (RIX). Фиксированная цена, подача от двери, опытный водитель, помощь на границе Беларусь–Латвия. ~470 км, 5–8 ч. Заказ онлайн или +375 (29) 155-27-76."
        descEn="Private door-to-door transfer from Minsk to Riga International Airport (RIX). Fixed price, professional driver, comfort or business class. ~470 km, 5–8 hrs incl. Belarus–Latvia border. Book online or call +375 (29) 155-27-76."
