...
const content = {
  ru: {
    ...
    steps: [
      { n: "01", title: "Оставьте заявку", desc: "Укажите маршрут, дату, пассажиров и багаж. Менеджер подтвердит стоимость в ближайшее время." },
    ...
    ctaDesc: "Оставьте заявку — менеджер подтвердит наличие и назовёт точную цену в ближайшее время.",
  ...
  en: {
    ...
    steps: [
      { n: "01", title: "Submit your request", desc: "Enter your route, date, passenger count and luggage. A manager will confirm the price shortly." },
    ...
    ctaDesc: "Submit your request and a manager will confirm availability with an exact price shortly.",
