...
const content = {
  ru: {
    ...
    faq: [
      { q: "Сколько стоит трансфер из Минска в аэропорт Вильнюса (VNO)?", a: "У нас фиксированная цена за всю машину (без счётчика) — её называет менеджер при бронировании, в зависимости от класса авто (комфорт / бизнес / минивэн), адреса подачи в Минске и времени суток. В стоимость уже включены топливо, страховка, помощь на границе, бутилированная вода и багаж — никаких доплат на месте." },
  ...
  en: {
    ...
    faq: [
      { q: "How much does a Minsk to Vilnius Airport (VNO) transfer cost?", a: "We quote a fixed price per car (no meter) — confirmed by our manager at booking based on the vehicle class (comfort / business / minivan), pickup address in Minsk and time of day. Fuel, insurance, border assistance, bottled water and luggage are already included — no extras at pickup or drop-off." },
