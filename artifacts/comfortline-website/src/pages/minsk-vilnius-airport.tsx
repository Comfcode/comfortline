...
const content = {
  ru: {
    ...
    steps: [
      ...
      { icon: "🛂", title: "Пересечение границы", desc: "Беларусь–Литва. Водитель поможет на КПП, знает актуальные маршруты и очереди." },
      { icon: "✈️", title: "Прибытие в аэропорт", desc: "Доставим прямо к нужному терминалу с запасом до вылета." },
    ],
  ...
  en: {
    ...
    steps: [
      ...
      { icon: "🛂", title: "Border crossing", desc: "Belarus–Lithuania. Your driver knows the border routines and monitors queue conditions." },
      { icon: "✈️", title: "Airport arrival", desc: "Delivered directly to the right terminal well ahead of your flight." },
    ],
