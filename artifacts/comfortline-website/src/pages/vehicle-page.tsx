...
const vehicleSeo: Record<string, { titleRu: string; titleEn: string; descRu: string; descEn: string; pathRu: string; pathEn: string; breadcrumbRu: string; breadcrumbEn: string }> = {
  "mercedes-e-class": {
    ...
    descRu: "Mercedes-Benz E-Class 2021 — представительский бизнес-седан с кожаным салоном и климат-контролем. Идеален для деловых поездок, встреч партнёров и трансферов в аэропорт. До 3 пассажиров, до 3 чемоданов.",
    descEn: "Mercedes-Benz E-Class 2021 — executive business sedan with leather interior and climate control. Ideal for business trips, partner meetings and airport transfers. Up to 3 passengers, up to 3 suitcases.",
  ...
  "kia-carnival": {
    ...
    descRu: "Kia Carnival — комфортный минивэн до 5 пассажиров с багажом. Идеален для семей, групп и багажа. Просторный салон, климат-контроль, индивидуальные кресла.",
    descEn: "Kia Carnival — comfortable minivan for up to 5 passengers with luggage. Ideal for families, groups and luggage. Spacious cabin, climate control, individual seats.",
  ...
  "hyundai-palisade": {
    ...
    descRu: "Hyundai Palisade — премиум-кроссовер до 4 пассажиров с большим багажом. Высокая посадка, кожаный салон, климат-контроль. Идеален для семейных поездок и трансферов с большим багажом.",
    descEn: "Hyundai Palisade — premium SUV for up to 4 passengers with extensive luggage. Elevated seating, leather interior, climate control. Ideal for family trips and transfers with extensive luggage.",
  ...
  "audi-a6": {
    titleRu: "Audi A6 Avant — бизнес-универсал для трансфера | ComfortLine",
    titleEn: "Audi A6 Avant — Business Estate Transfer | ComfortLine",
    descRu: "Audi A6 Avant — стильный бизнес-универсал с просторным багажником до 4 чемоданов. До 3 пассажиров, кожаный салон, климат-контроль. Идеален для трансферов в аэропорты Вильнюса, Варшавы, Риги.",
    descEn: "Audi A6 Avant — elegant business estate with a large boot for up to 4 suitcases. Up to 3 passengers, leather interior, climate control. Ideal for transfers to Vilnius, Warsaw and Riga airports.",
    pathRu: "/трансфер-ауди-а6",
    pathEn: "/audi-a6-transfer",
    breadcrumbRu: "Audi A6 Avant",
    breadcrumbEn: "Audi A6 Avant",
  },
  "fiat-scudo": {
...
const vehicleContent: Record<string, BilingualVehicle> = {
  "mercedes-e-class": {
    ru: {
      ...
      photos: [
        { src: "/car-mercedes-e-front.webp",   label: "Экстерьер — вид спереди" },
        { src: "/car-mercedes-e-side2.webp",   label: "Экстерьер — вид сбоку" },
        { src: "/car-mercedes-e-interior.webp", label: "Интерьер — задний ряд" },
        { src: "/car-mercedes-e-side1.webp",   label: "Экстерьер — в движении" },
      ],
      ...
      ctaDesc: "Оставьте заявку — менеджер свяжется в ближайшее время и назовёт точную стоимость.",
    ...
    en: {
      ...
      image: "/car-mercedes-e-front.webp",
      photos: [
        { src: "/car-mercedes-e-front.webp",   label: "Exterior — front view" },
        { src: "/car-mercedes-e-side2.webp",   label: "Exterior — side view" },
        { src: "/car-mercedes-e-interior.webp", label: "Interior — rear cabin" },
        { src: "/car-mercedes-e-side1.webp",   label: "Exterior — on the road" },
      ],
  ...
  "kia-carnival": {
    ru: {
      ...
      idealFor: [
        ...
        "Групповые трансферы до 5 человек",
    ...
    en: {
      ...
      featuresLabel: "Vehicle equipment",
      features: [
        "Up to 5 passengers with luggage",
      ...
      idealFor: [
        ...
        "Group transfers of up to 5 people",
  ...
  "hyundai-palisade": {
    ru: {
      ...
      featuresLabel: "Оснащение автомобиля",
      features: [
        "До 4 пассажиров с большим багажом",
        "Полный привод (AWD)",
        "Высокий клиренс",
        "Панорамная крыша",
        "Климат-контроль",
    ...
    en: {
      ...
      featuresLabel: "Vehicle equipment",
      features: [
        "Up to 4 passengers with large luggage",
        "All-wheel drive (AWD)",
      ...
      idealFor: [
        ...
        "Group transfers up to 4 people",
  ...
  "audi-a6": {
    ru: {
      ...
      year: "2021",
      seats: 3,
      luggage: "до 4 чемоданов",
      image: "/car-audi-a6-front.webp",
      interiorImage: "/car-audi-a6-rear.webp",
      desc: "Представительский универсал Audi A6 Avant с большим багажником и динамичным характером. Сочетает деловой стиль с практичностью — идеален для длительных маршрутов в аэропорты Европы.",
      featuresLabel: "Оснащение автомобиля",
      features: [
        "До 3 пассажиров с багажом",
        "Увеличенный багажный отсек",
        "Кожаный салон",
        "Климат-контроль",
        "USB-зарядка",
        "Питьевая вода в дороге",
      ...
      idealLabel: "Подходит для",
      idealFor: [
        "Деловые поездки и встречи партнёров",
        "Трансферы в аэропорт с большим багажом",
        "Длительные маршруты Минск — Вильнюс, Варшава, Рига",
        "Индивидуальные поездки в комфорте",
      ],
      routesLabel: "Доступные маршруты",
      ctaTitle: "Забронировать Audi A6 Avant",
      ctaDesc: "Оставьте заявку — менеджер свяжется в ближайшее время и назовёт точную стоимость.",
      ctaBtn: "Оставить заявку",
      backBtn: "← Автопарк",
      specsSeats: "Мест",
    ...
    en: {
      ...
      image: "/car-audi-a6-front.webp",
      interiorImage: "/car-audi-a6-rear.webp",
      desc: "The Audi A6 Avant is a sophisticated business estate combining executive style with a generous boot. Perfect for long-haul airport runs across Europe — smooth, quiet and refined.",
      featuresLabel: "Vehicle equipment",
      features: [
        "Up to 3 passengers with luggage",
        "Large estate boot",
        "Leather interior",
        "Climate control",
        "USB charging",
      ...
      idealLabel: "Ideal for",
      idealFor: [
        "Business trips and partner pickups",
        "Airport transfers with heavy luggage",
        "Long-haul routes Minsk — Vilnius, Warsaw, Riga",
        "Individual travel in comfort",
      ],
      routesLabel: "Available routes",
      ctaTitle: "Book the Audi A6 Avant",
      ctaDesc: "Submit a request and our manager will contact you shortly with an exact price.",
      ctaBtn: "Request a booking",
      backBtn: "← Fleet",
      specsSeats: "Seats",
