...
const data: RoutePageData = {
  ru: {
    ...
    faq: [
      { q: "Сколько стоит трансфер из Минска в санаторий «Нарочь»?", a: "Цена — по запросу, свяжитесь с нами. Стоимость зависит от класса авто (бизнес-седан 1–4 пассажира или минивэн 5–8), необходимости детского кресла, поездки с домашним животным, конкретного санатория и даты, а также других пожеланий клиента. Маршрут до Нарочи ~160 км, время в пути 2–2,5 часа. Менеджер озвучит фиксированную сумму с включёнными топливом, страховкой, помощью с багажом и подачей от любого адреса в Минске." },
  ...
  en: {
    ...
    faq: [
      { q: "How much is a transfer from Minsk to Naroch resort?", a: "Price is on request — please contact us. The exact figure depends on the vehicle class (business sedan for 1–4 passengers or minivan for 5–8), whether you need a child seat, whether you travel with a pet, the chosen resort and date, and any other special requests. The route to Naroch is ~160 km, around 2–2.5 hours one way. Our manager confirms a fixed price with fuel, insurance, luggage help and pickup from any Minsk address already included." },
