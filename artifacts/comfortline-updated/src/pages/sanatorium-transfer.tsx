...
const data: RoutePageData = {
  ru: {
    ...
    ctaDesc: "Оставьте заявку — менеджер свяжется в ближайшее время, уточнит санаторий и назовёт точную стоимость в обе стороны.",
  ...
  en: {
    ...
    ctaDesc: "Submit a request — our manager will reach out shortly, confirm the resort and quote a fixed return price.",
