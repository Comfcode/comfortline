...
const data: RoutePageData = {
  ru: {
    ...
    ctaDesc: "Оставьте заявку — менеджер свяжется в ближайшее время, уточнит количество людей и снаряжения и назовёт стоимость.",
  ...
  en: {
    ...
    ctaDesc: "Submit a request — our manager will reach out shortly, confirm passenger and gear count, and quote a price.",
