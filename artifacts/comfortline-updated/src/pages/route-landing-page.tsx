...
const RELATED_ROUTES = [
  {
    ru: ["Такси Минск — Вильнюс", "/трансфер-минск-вильнюс"],
    en: ["Minsk to Vilnius transfer", "/minsk-vilnius-transfer"],
  },
  {
    ru: [
      "Трансфер Минск — аэропорт Вильнюса (VNO)",
      "/трансфер-минск-вильнюс-аэропорт",
    ],
    en: ["Minsk to Vilnius Airport (VNO)", "/minsk-vilnius-airport"],
  },
  {
    ru: ["Такси Минск — Каунас", "/трансфер-минск-каунас"],
    en: ["Minsk to Kaunas transfer", "/minsk-kaunas-transfer"],
  },
  {
    ru: [
      "Трансфер Минск — аэропорт Каунаса (KUN)",
      "/трансфер-минск-каунас-аэропорт",
    ],
    en: ["Minsk to Kaunas Airport (KUN)", "/minsk-kaunas-airport"],
  },
  {
    ru: ["Такси Минск — Рига", "/трансфер-рига"],
    en: ["Minsk to Riga transfer", "/riga-transfer"],
  },
  {
    ru: [
      "Трансфер Минск — аэропорт Риги (RIX)",
      "/трансфер-минск-рига-аэропорт",
    ],
    en: ["Minsk to Riga Airport (RIX)", "/minsk-riga-airport"],
  },
  {
    ru: ["Такси Минск — Варшава", "/трансфер-варшава"],
    en: ["Minsk to Warsaw transfer", "/warsaw-transfer"],
  },
  {
    ru: [
      "Трансфер Минск — аэропорт Шопен (WAW)",
      "/трансфер-минск-варшава-шопен",
    ],
    en: ["Minsk to Warsaw Chopin Airport (WAW)", "/minsk-warsaw-airport"],
  },
  {
    ru: [
      "Трансфер Минск — аэропорт Модлин (WMI)",
      "/трансфер-минск-варшава-модлин",
    ],
    en: [
      "Minsk to Warsaw Modlin Airport (WMI)",
      "/minsk-warsaw-modlin-airport",
    ],
  },
  {
    ru: ["Такси Минск — Гданьск", "/трансфер-минск-гданьск"],
    en: ["Minsk to Gdańsk transfer", "/minsk-gdansk-transfer"],
  },
  {
    ru: ["Такси Минск — Краков", "/трансфер-минск-краков"],
    en: ["Minsk to Kraków transfer", "/minsk-krakow-transfer"],
  },
  {
    ru: ["Такси Минск — Вроцлав", "/трансфер-минск-вроцлав"],
    en: ["Minsk to Wrocław transfer", "/minsk-wroclaw-transfer"],
  },
  {
    ru: ["Такси Минск — Познань", "/трансфер-минск-познань"],
    en: ["Minsk to Poznań transfer", "/minsk-poznan-transfer"],
  },
  {
    ru: ["Такси Минск — Катовице", "/трансфер-минск-катовице"],
    en: ["Minsk to Katowice transfer", "/minsk-katowice-transfer"],
  },
  {
    ru: ["Такси Минск — Клайпеда", "/трансфер-минск-клайпеда"],
    en: ["Minsk to Klaipėda transfer", "/minsk-klaipeda-transfer"],
  },
  {
    ru: ["Такси Минск — Паланга", "/трансфер-минск-паланга"],
    en: ["Minsk to Palanga transfer", "/minsk-palanga-transfer"],
  },
] as const;
...
export function RouteLandingPage({ data }: Props) {
  ...
  const currentRouteIndex = Math.max(
    0,
    RELATED_ROUTES.findIndex((route) => route[lang][1] === seoPath),
  );
  const relatedRoutes = Array.from(
    { length: 6 },
    (_, offset) =>
      RELATED_ROUTES[(currentRouteIndex + offset + 1) % RELATED_ROUTES.length][
        lang
      ],
  );
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="pt-28 pb-14 border-b border-border/40 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-4xl relative">
          <a
            href={getHomeSectionHref(lang, "services")}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {c.stats.map((s) => (
              ...
              >
                <p className="text-primary font-bold text-sm leading-snug break-words">
                  {s.value}
                </p>
              ...
              onClick={() =>
                window.dispatchEvent(
                  new CustomEvent("open-booking-modal", {
                    detail: {
                      prefilledFrom: c.prefilledFrom,
                      prefilledTo: c.prefilledTo,
                    },
                  }),
                )
              }
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-4xl py-14 space-y-16">
                  ...
                  <img
                    ...
                    onError={(e) => {
                      ...
                      parent.style.background =
                        "linear-gradient(135deg, #1C1B24 0%, #2a2535 100%)";
                      const span = document.createElement("span");
                      span.textContent = photo.caption;
                      span.className =
                        "absolute inset-0 flex items-center justify-center text-primary/70 text-sm font-semibold text-center p-4";
        ...
        >
          ...
          <div className="bg-card border border-border rounded-2xl overflow-hidden">
            {c.infoRows.map((row, i) => (
              ...
              >
                <span className="text-muted-foreground text-sm min-w-[200px] shrink-0">
                  {row.label}
                </span>
        ...
        >
          <h2 className="text-2xl font-bold text-foreground mb-6">
            {isRu
              ? "Популярные направления из Минска"
              : "Popular private transfers from Minsk"}
          </h2>
          <nav
            aria-label={isRu ? "Похожие маршруты" : "Related routes"}
          ...
          >
            {relatedRoutes.map(([label, href]) => (
              <a
                key={href}
                href={href}
                className="flex items-center justify-between gap-3 bg-card border border-border rounded-xl px-5 py-4 text-sm font-medium text-foreground hover:border-primary/50 hover:text-primary transition-colors"
              >
                {label}
    ...
    <div className="bg-card border border-border rounded-xl overflow-hidden">
      ...
      {open && (
        <div
          id={id}
          role="region"
          className="px-5 pb-4 -mt-1 text-sm text-muted-foreground leading-relaxed"
        >
          {a}
        </div>
      )}
