...
const data: RoutePageData = {
  ru: {
    ...
    faq: [
      { q: "Сколько стоит трансфер из Минска в Варшаву?", a: "Цена — по запросу, свяжитесь с нами. Стоимость зависит от класса авто (бизнес-седан 1–3 пассажира или минивэн 4–8), необходимости детского кресла, поездки с домашним животным, конечного адреса в Варшаве, сезона и других пожеланий клиента. Менеджер озвучит фиксированную сумму без счётчика — без доплат на месте, с включёнными топливом, страховкой, помощью на границе, водой и багажом без ограничений." },
      ...
      { q: "Можно ли сделать остановку по дороге?", a: "Да. Бесплатно — техническая остановка на АЗС каждые 2 часа. Платные остановки (заехать в Брестскую крепость, торговый центр в Бресте или в Тересполе обменять валюту) бронируются заранее у менеджера и стоят символическую сумму за остановку до 30 минут." },
      ...
      { q: "Какой автомобиль подадут?", a: "По умолчанию Mercedes-Benz E-class (бизнес-седан, до 3 пассажиров с багажом) или Volkswagen Passat (комфорт, до 3 пассажиров с багажом). Для группы 4–5 человек — Hyundai Palisade (до 4) или Kia Carnival (до 5); для 6–8 человек — Fiat Scudo. Все автомобили не старше 5 лет, с кондиционером и Wi-Fi." },
    ],
  ...
  en: {
    ...
    faq: [
      { q: "How much does a Minsk to Warsaw transfer cost?", a: "Price is on request — please contact us. The exact figure depends on the vehicle class (business sedan for 1–3 passengers or minivan for 4–8), whether you need a child seat, whether you travel with a pet, your final Warsaw address, the season, and any other special requests. Our manager confirms a fixed price (no meter) with fuel, insurance, border assistance, bottled water and unlimited luggage already included — no extras at pickup or drop-off." },
      ...
      { q: "Can I make stops along the way?", a: "Yes. Free technical stops at petrol stations every 2 hours. Paid stops (Brest Fortress, a Brest shopping centre, or a currency exchange in Terespol) are arranged in advance with our manager for a small fee per stop up to 30 minutes." },
  ...
  seo: {
    ...
    descRu: "Частный трансфер Минск — центр Варшавы: 550 км, фиксированная цена, подача от двери и помощь на границе Беларусь — Польша.",
    descEn: "Private Minsk to central Warsaw transfer: 550 km, fixed fare, door-to-door pickup and assistance at the Belarus–Poland border.",
